...
<body>
    <h1 style="text-align: center;">Welcome to RIANI's Library</h1>
    <hr>
    <div class="row">
			<div class="col">
				<div class="mark">
		...
		<div class="row wow bounceIn" duration="2s" delay="5s">
			<div class="col">
				<div class="visi">
					<h3>Media Sosial</h3>
					<div class="container">
                        <a class="link" href="https://www.linkedin.com/in/miqbalfaiz/"><img src="linkedin_logo.png" width="3%"></a>
						<a class="link2" href="https://twitter.com/Cruzers556"><img src="twitter_logo.png" width="3%"></a>
